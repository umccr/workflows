...
# supposes reference data exists in '/RNAsum/data' inside the reference data bucket
echo "PULL ref data from S3 bucket"
aws s3 sync --only-show-errors s3://${S3_REFDATA_BUCKET}/RNAsum/data /work/WTS_ref_data
